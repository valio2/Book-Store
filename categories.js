var categories = {
    javascript: {
        book1: {
            ...
            pages: 309,
            description: `JavaScript is the programming language of the Internet,
            the secret sauce that makes the Web awesome,
            your favorite sites interactive,
    ...
    java: {
        ...
        book2: {
            title: `Java: A Beginner's Guide, Sixth Edition: A Beginner's Guide, Sixth Edition`,
